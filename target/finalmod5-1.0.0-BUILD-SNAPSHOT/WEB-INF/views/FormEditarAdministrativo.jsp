	...
	<fieldset class="cel- agrupar-t agrupar-e">
		<form method="post" action='<c:out value="${pageContext.request.contextPath}" />/procesaeditar'>
			<table class="tablausr-t tablausr-e">
					...
					<tr><td>Nombre</td><td><input type="text" name="txtnomadmin" id="txtnomadmin" value='<c:out value="${ad.getUsernombre()}" />' /></td></tr>
					<tr><td>Apellidos</td><td><input type="text" name="txtapeadmin" id="txtapeadmin" value='<c:out value="${ad.getUserapellidos()}" />' /></td></tr>
